  ...
  time: {
    ...
    getNowTime(timestamp, status) {
      ...
      var time = new Date(timestamp * 1000),
        ...
        day = this.fixZero(timesttimeamp.getDate(), 2),
    ...
    TimeDifference(lasttime) {
      ...
      //获取发布问题或回答问题的时间
      var dateline = new Date(parseInt(lasttime) * 1000);
      ...
      if (datenowMonth - datelineMonth >= 1) {
        result = this.toFormatString(dateline, "yyyy-MM-dd");
      }
    ...
    toFormatString(time, formatString) {
